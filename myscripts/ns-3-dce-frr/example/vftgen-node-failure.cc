...
int main (int argc, char *argv[])
{
  ...
  {
  case 0:
    frr.BgpNodeFailure(fat_tree->pods->at(0)->leaves->at(0)->node, Seconds (30.0));
    break;
  case 1:
    frr.BgpNodeFailure(fat_tree->pods->at(0)->spines->at(0)->node, Seconds (30.0));
    break;
  case 2:
    frr.BgpNodeFailure(fat_tree->aggregaion_layer->at(0)->node, Seconds (30.0));
    break;
  }
